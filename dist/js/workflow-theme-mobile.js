...
function($) {
    ...
    Tooltip.prototype.init = function(type, element, options) {
        ...
        this.$viewport = this.options.viewport && $($.isFunction(this.options.viewport) ? this.options
        ...
        for (var i = triggers.length; i--;) {
            ...
            if (trigger == 'click') {
                ...
                this.$element.on(eventIn + '.' + this.type, this.options.selector, $.proxy(this
                    .enter, this))
                this.$element.on(eventOut + '.' + this.type, this.options.selector, $.proxy(
                    this.leave, this))
            }
        }
    ...
    Tooltip.prototype.show = function() {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var inDom = $.contains(this.$element[0].ownerDocument.documentElement, this.$element[
                0])
    ...
    Tooltip.prototype.applyPlacement = function(offset, placement) {
        ...
        var arrowDelta = isVertical ? delta.left * 2 - width + actualWidth : delta.top * 2 -
            height + actualHeight
...
(function() {
    $(document).on('click', '[data-name="back"]', function() {
        window.history.go(-1);
    });
})();